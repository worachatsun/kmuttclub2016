...
<?php echo HTML::script('themes/alchemist/assets/scripts/login-soft.js');?>
...
<script>
    jQuery(document).ready(function() {
         ...
         $.backstretch([
            "{{ url('themes/alchemist/assets/img/bg/1.jpg') }}",
            "{{ url('themes/alchemist/assets/img/bg/2.jpg') }}",
            "{{ url('themes/alchemist/assets/img/bg/3.jpg') }}",
            "{{ url('themes/alchemist/assets/img/bg/4.jpg') }}",
            ], {
              fade: 1000,
              duration: 8000
        }
